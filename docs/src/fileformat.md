...
If you specify the option `tbme_fmt="snt.bin"` for Chiral EFT interactions, the output becomes binary form, where the integers are in `Int16` (not `Int64`) and floating point numbers are in `Float64`.
